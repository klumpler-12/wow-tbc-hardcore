...
window.HCData = {
  ...
  // Instance Lives — Heroic Dungeons + Raids
  instanceLives: {
    heroic: [
  ...
  // Punishments — 7 rows
  punishments: [
    { cat: 'death',      icon: '\u2620', name: 'Instance Death',        severity: 90,  label: 'Critical', action: 'Lose 1 life + score penalty',         tip: 'Instance deaths consume lives from your pool', reward: false, enabled: true },
